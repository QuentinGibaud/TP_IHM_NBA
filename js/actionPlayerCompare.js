/**
* Script with all the functions called to compare players
**/

/**
* Function addDataPlayerCompare() : 
* return the list of players
* param : id, the id of the section
**/
function addDataPlayerCompare(id){
    d3.csv("data/NBA_data.csv", function(data){
                                                        d3.select("#blocNavElementList"+id).selectAll("p")
                                                          ...
                                                          .attr("onclick",function(d){return "selectPlayer('" + d.Name +"',1,"+id+");";})
                                                          .style("margin", "0")  
...
* param : id, the id of the section
**/
function selectPlayer(elemID,pro,id){
    ...
    d3.csv("data/NBA_data.csv", function (error,data) {
        ...
        **/
        function tabulate(data, columns, label, units) {
            ...
            var table = d3.select("#Centre"+id).append('table')
        ...
        d3.select("#Centre"+id).select("table").remove();
